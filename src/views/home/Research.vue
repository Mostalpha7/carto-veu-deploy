      ...
      <div class="py-4">
        ...
        <div class="py-5 row justify-content-center">
          <div class="priorities">
            <a class="priority" href="/resources">
              <h4>Cancers</h4>
            </a>
            <a class="priority" href="/resources">
              <h4>COVID-19</h4>
            ...
            <a class="priority" href="/resources">
              <h4>Food security and nutrition</h4>
            </a>
            <a class="priority" href="/resources">
              <h4>Health Systems and policy</h4>
            </a>
            <a class="priority" href="/resources">
        ...
        <div class="">
          <div class="mt-4">
            <h3 class="text-center mt-5 mb--md-5 mb-2">Policy Briefs</h3>
...
.priorities {
  display: grid;
  grid: repeat(3, 150px) / repeat(4, 200px);
  grid-row-gap: 20px;
  grid-column-gap: 20px;
  justify-content: center;
  margin-bottom: 5%;
  @include mobile {
    grid: auto/repeat(2, 150px);
  }
  .priority {
